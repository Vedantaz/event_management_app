...
exports.Messages = {
    ...
    REGISTERING_THANKS: "Thank you for registering. We are excited to have you on board.",
    ...
    FAIL_TO_SEND_EMAIL_CANCELLATION: "Failed to send booking cancellation email to",
    FAIL_TO_SEND_EMAIL_CONFIRMATION: "Failed to send booking confirmation email to ",
