...
var ReviewService = function () {
    ...
    var ReviewService = _classThis = /** @class */ (function () {
        function ReviewService_1(prisma) {
            this.prisma = prisma;
        }
        ReviewService_1.prototype.createReview = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var event, existingReview;
                        ...
                        case 2:
                            ...
                            if (existingReview) {
                                throw new common_1.BadRequestException({
                                    ...
                                    message: booking_constants_1.bookingMessages.REVIEW_ALREADY_EXISTS,
                                });
                            }
        ...
        ReviewService_1.prototype.getALlReviews = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var orderBy;
                return __generator(this, function (_a) {
                    orderBy = {
                    ...
                    if (data.sortBy === enums_1.ReviewSortBy.RATING)
                        orderBy = { rating: "desc" };
                    return [2 /*return*/, this.prisma.review.findMany({
                            orderBy: orderBy,
                        })];
                });
            });
        };
        ReviewService_1.prototype.updateReview = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var review;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.review.findFirst({
                                where: {
                                    userId: userId,
                                },
                        ...
                        case 1:
                            ...
                            if (!review) {
                                throw new common_1.NotFoundException({
                                    ...
                                    message: booking_constants_1.bookingMessages.REVIEW_NOT_FOUND,
                                });
                            }
                            if (review.userId !== userId) {
                                throw new common_1.ForbiddenException({
                                    message: booking_constants_1.reviewMessages.NOT_ALLOWED_TO_UPDATE,
                                });
                            }
                            if (!data) {
        ...
        ReviewService_1.prototype.removeReview = function (reviewId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var review;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.review.delete({ where: { id: reviewId } })];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
