...
var users_constants_1 = require("../../common/constants/users.constants");
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.ensureUploadImg = function () {
            if (!fs.existsSync(this.uploadDir)) {
                fs.mkdirSync(this.uploadDir, { recursive: true });
            }
        };
        UsersService_1.prototype.findByMail = function (email) {
        ...
        UsersService_1.prototype.updateUser = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, hasValidUpdateData;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            hasValidUpdateData = data &&
                                Object.values(data).some(function (value) { return value !== undefined && value !== null && value !== ""; });
                            if (!hasValidUpdateData) {
                                throw new common_1.BadRequestException(users_constants_1.Messages.USER.NOT_DATA_TO_UPDATE);
                            }
